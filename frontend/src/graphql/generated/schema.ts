...
export type AddNewTaskMutation = { __typename?: 'Mutation', createTask: { __typename?: 'Task', id: number, description?: string | null, finished?: boolean | null, name: string, creationDate: any } };
